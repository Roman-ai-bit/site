...
class RequestHandlerClient
{
    ...
    public function run()
    {
        ...
        $headers['auth']['clientId'] = 196;
        $headers['auth']['clientCompany'] = "sH7vsz2s7JkcCcZMoAc6";
        $headers['auth']['clientSecret'] = "MTk2c0g3dnN6MnM3SmtjQ2NaTW9BYzZjZTY2ZjZlNmY5ZGVmNTEwYWM0MGJhMmU2NWMyYWNkYTAxNDJmZmFl";
